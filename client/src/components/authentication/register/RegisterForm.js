...
// material
import { Stack, TextField, IconButton, InputAdornment, Alert, Box, Typography } from '@material-ui/core';
    ...
    <FormikProvider value={formik}>
      <Form autoComplete="off" noValidate onSubmit={handleSubmit}>
        <Stack spacing={3}>
          ...
          <Stack direction={{ xs: 'column', marginTop: '10px !important', sm: 'row' }} spacing={2}>
            <Box sx={{ flexGrow: 1 }}>
          ...
          <LoadingButton size="large" type="submit" variant="contained" loading={isSubmitting} sx={{ backgroundColor: '#2fc557', boxShadow: 'none', width: '50%', margin: '24px auto !important', marginBottom: '0 !important'  }}>
            Sign Up
          </LoadingButton>
        </Stack>
      </Form>
