...
const rows = [
  createRow('Main Ticket', 100),
  createRow('Satellite1', 10),
  createRow('Satellite2', 2),
];
                    ...
                    <TableBody>
                      {rows.map((row) => (
                        <TableRow key={row.desc}>
                          <TableCell align="left" colSpan={3} sx={{color: 'black'}}>{row.desc}</TableCell>
                          <TableCell align="left" colSpan={2} sx={{color: 'black'}}>{ccyFormat(row.qty)}</TableCell>
                        </TableRow>
                      ))}
                    </TableBody>
                  </TableStyle>
